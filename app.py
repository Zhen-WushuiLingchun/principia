...
def convert_format():
    try:
        ...
        if target_format == 'tex':
            ...
            4. Keep existing LaTeX math ($...$, $$...$$) unchanged.
            5. Return ONLY the converted LaTeX body code. Do NOT wrap in \\documentclass.
            ...
            Rules:
            1. Convert LaTeX sections (\\section, \\subsection) to Markdown headers (#, ##).
            2. Convert LaTeX lists to Markdown lists.
            3. Convert LaTeX text formatting (\\textbf, \\textit) to Markdown (**...**, *...*).
            4. Keep LaTeX math ($...$, $$...$$) unchanged.
            5. Return ONLY the converted Markdown content.
            6. Do not include markdown code fences.
